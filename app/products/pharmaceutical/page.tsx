    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-purple-800">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl font-bold text-white mb-6">Pharmaceutical Reactor Systems</h1>
          <p className="text-xl text-purple-100 max-w-2xl mx-auto">
            GMP-compliant pharmaceutical manufacturing equipment and reactor systems from leading global suppliers
          </p>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Pharmaceutical Manufacturing Solutions</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              FDA and GMP-compliant pharmaceutical processing equipment from certified manufacturers worldwide
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Pharmaceutical Reactor Systems</h3>
                <p className="text-gray-600 mb-4">
                  High-grade 316L stainless steel reactors from Pfaudler, De Dietrich, and Büchi for API synthesis and chemical processing
                </p>
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Mixing & Agitation Systems</h3>
                <p className="text-gray-600 mb-4">
                  Precision mixing technology from Silverson, IKA, and Ekato for pharmaceutical formulation and processing
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Filtration & Separation Systems</h3>
                <p className="text-gray-600 mb-4">
                  Sterile filtration systems from Pall, Millipore, and Sartorius for pharmaceutical grade separation processes
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Drying & Crystallization Systems</h3>
                <p className="text-gray-600 mb-4">
                  Advanced drying technology from GEA, Buchi, and Hosokawa for pharmaceutical solid processing applications
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Process Control & Automation</h3>
                <p className="text-gray-600 mb-4">
                  21 CFR Part 11 compliant control systems from Siemens, Rockwell, and Schneider for pharmaceutical manufacturing
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Heat Transfer Systems</h3>
                <p className="text-gray-600 mb-4">
                  Precise temperature control systems from Julabo, Huber, and Lauda for pharmaceutical thermal processing
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose Our Pharmaceutical Equipment?</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Trusted by pharmaceutical manufacturers worldwide for GMP-compliant processing equipment
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                FDA, EMA, and GMP-compliant equipment with complete documentation and validation support
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Precision Engineering</h3>
              <p className="text-gray-600">
                Ultra-high precision equipment designed for consistent pharmaceutical production and quality assurance
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Validation Services</h3>
              <p className="text-gray-600">
                Comprehensive IQ/OQ/PQ validation services and ongoing technical support for pharmaceutical applications
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Pharmaceutical equipment serving critical manufacturing processes across various sectors
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-lg text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">API Manufacturing</h3>
              <p className="text-gray-600 text-sm">Active pharmaceutical ingredient synthesis and processing</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Fine Chemicals</h3>
              <p className="text-gray-600 text-sm">Specialty chemical and pharmaceutical intermediate production</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">R&D Laboratories</h3>
              <p className="text-gray-600 text-sm">Research and development scale reactor systems</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Biotechnology</h3>
              <p className="text-gray-600 text-sm">Biopharmaceutical production and fermentation systems</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-purple-600">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-white mb-6">Ready to Enhance Your Manufacturing Capabilities?</h2>
          <p className="text-xl text-purple-100 mb-8 max-w-2xl mx-auto">
            Connect with verified suppliers for GMP-compliant pharmaceutical reactors and processing equipment
          </p>
          <Link href="/contact" className="bg-white text-purple-600 hover:bg-gray-100 px-8 py-4 rounded-lg text-lg font-semibold transition-colors cursor-pointer whitespace-nowrap">
