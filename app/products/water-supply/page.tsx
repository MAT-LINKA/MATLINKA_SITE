    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-800">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl font-bold text-white mb-6">Water Supply & Fluid Management Systems</h1>
          <p className="text-xl text-blue-100 max-w-2xl mx-auto">
            Comprehensive water infrastructure solutions from leading manufacturers for municipal, industrial, and agricultural applications
          </p>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Professional Water Management Solutions</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Industry-leading water supply equipment and fluid handling systems from certified global manufacturers
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Industrial Water Pumps</h3>
                <p className="text-gray-600 mb-4">
                  High-efficiency pumps from Grundfos, Xylem, and KSB for water supply, irrigation, and fluid transfer applications
                </p>
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Industrial Gate Valves</h3>
                <p className="text-gray-600 mb-4">
                  AWWA-compliant gate valves from AVK, American Flow Control, and Mueller for water distribution systems
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Water Treatment Systems</h3>
                <p className="text-gray-600 mb-4">
                  Advanced water treatment solutions from Pentair, Evoqua, and Veolia for potable water production and wastewater treatment
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Hydro Turbine Systems</h3>
                <p className="text-gray-600 mb-4">
                  Hydroelectric turbines and generators from Andritz, Voith, and GE for renewable energy generation projects
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Power Generation Systems</h3>
                <p className="text-gray-600 mb-4">
                  Reliable generators from Caterpillar, Cummins, and Kohler for water treatment facilities and pumping stations
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Water Storage Solutions</h3>
                <p className="text-gray-600 mb-4">
                  Engineered storage systems from Caldwell, CB&I, and Tank Connection for municipal and industrial water storage
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Irrigation Systems</h3>
                <p className="text-gray-600 mb-4">
                  Precision irrigation solutions from Netafim, Rain Bird, and Toro for agricultural and landscape applications
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Piping & Distribution Systems</h3>
                <p className="text-gray-600 mb-4">
                  AWWA-standard piping systems from JM Eagle, North American Pipe, and American Cast Iron for water distribution
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose Our Water Solutions?</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Trusted by water utilities and engineering professionals worldwide for reliable water management systems
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Water Efficiency Standards</h3>
              <p className="text-gray-600">
                All systems designed for optimal water usage efficiency and conservation compliance
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Environmental Compliance</h3>
              <p className="text-gray-600">
                EPA and international environmental standards compliance for sustainable water management
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Comprehensive engineering support and system integration services for complex water projects
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Water management solutions serving critical infrastructure and industrial applications
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-lg text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Municipal Water Systems</h3>
              <p className="text-gray-600 text-sm">City water treatment and distribution infrastructure</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Agricultural Irrigation</h3>
              <p className="text-gray-600 text-sm">Precision irrigation and crop water management</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Industrial Processing</h3>
              <p className="text-gray-600 text-sm">Process water and cooling system solutions</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Hydroelectric Power</h3>
              <p className="text-gray-600 text-sm">Renewable energy generation systems</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-blue-600">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-white mb-6">Ready to Optimize Your Water Infrastructure?</h2>
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Connect with verified suppliers for premium water pumps, turbines, valves, and treatment systems at competitive prices
          </p>
