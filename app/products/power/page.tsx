      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-green-800">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-green-100 max-w-2xl mx-auto">
            Comprehensive renewable energy solutions from tier-1 manufacturers
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Premium Energy Solutions Portfolio
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Industry-leading renewable energy equipment and electrical systems
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Tier-1 solar modules from leading manufacturers including
                  Jinko, Trina, and Canadian Solar with 25-year warranties
                </p>
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Advanced DC-to-AC conversion systems from SMA, Fronius, and
                  Huawei with grid-tie and off-grid capabilities
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  UL-listed electrical panels and switchgear from Schneider
                  Electric, ABB, and Siemens for safe power distribution
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Prime and standby generators from Caterpillar, Cummins, and
                  Perkins for reliable backup power solutions
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Horizontal and vertical axis wind turbines from GE, Vestas,
                  and Goldwind for commercial wind energy projects
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Complete wind energy systems including control systems, power
                  conditioning, and grid integration solutions
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Engineered mounting systems and electrical accessories from
                  Schletter, Unirac, and other certified manufacturers
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Solar-powered water pumping solutions from Grundfos, Lorentz,
                  and Franklin Electric for irrigation and water supply
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Renewable energy solutions serving diverse sectors and
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-lg text-center">
              ...
              <p className="text-gray-600 text-sm">
                Rooftop solar and home energy storage solutions
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg text-center">
              ...
              <p className="text-gray-600 text-sm">
                MW-scale solar and wind power projects
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg text-center">
              ...
              <p className="text-gray-600 text-sm">
                Remote power and telecommunications systems
              </p>
            </div>
          </div>
        </div>
